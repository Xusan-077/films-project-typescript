...
const elSortToLetterForm = document.querySelector(".sort-form") as HTMLFormElement
const elSortToLetterSelect = document.querySelector(".sort-select") as HTMLSelectElement
...
elSortToGenresForm.onsubmit = (evt: Event) => {
  evt.preventDefault()
